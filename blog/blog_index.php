        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="../pages/vehicles.php" class="text-white hover:text-gray-200 transition-all">Collection</a>
                    <a href="../blog/blog_index.php" class="text-white hover:text-gray-200 transition-all">Blog</a>
    ...
    <div class="bg-gradient-primary py-12">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex flex-col items-center space-y-6">
                <h1 class="text-4xl font-bold text-center text-white">Drive & Loc Community Blog</h1>
                <div class="w-full max-w-2xl">
                    <div class="flex gap-4">
                        <input type="text" placeholder="Search articles..." class="w-full px-4 py-2 rounded-lg border focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <button class="btn-primary text-white px-6 py-2 rounded-lg">Search</button>
                    </div>
                </div>
                <!-- Tags Filter -->
                ...
                ?>
                    <form action="../handling/themeshow.php" method="post" class="text-center">
                        <div>
                            ...
                            <button style="width: 220px" type="submit" class="bg-white p-4 rounded-lg shadow-soft text-center cursor-pointer hover:shadow-lg transition-shadow"><?php echo $row['name'] ?></button>
                        </div>
                    </form>
                <?php } ?>
            </div>
